...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "zproto" is the name you will use in your source code to
                // import this module (e.g. `@import("zproto")`). The name is
    ...
    for (examples) |example| {
        ...
        const example_step = b.step(example.name, std.fmt.allocPrint(b.allocator, "Run {s}", .{example.name}) catch "Run example");
    ...
    test_runner_step.dependOn(&test_run.step);
